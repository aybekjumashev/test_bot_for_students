...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('question_file_uz', models.FileField(blank=True, null=True, upload_to=core.models.question_file_path_uz, verbose_name="Savol fayli (O'zbekcha, DOCX)")),
                ('question_file_kaa', models.FileField(blank=True, null=True, upload_to=core.models.question_file_path_kaa, verbose_name='Savol fayli (Qoraqalpoqcha, DOCX)')),
                ('question_file_ru', models.FileField(blank=True, null=True, upload_to=core.models.question_file_path_ru, verbose_name='Savol fayli (Ruscha, DOCX)')),
